...
* _--project-name_ - название проекта
* _--base-domain_ - базовый домен
* _--namespace_ - namespace
* _--name_ - имя стейджинга
* _--tag_ - тег стейджинга
* _--app-env-override_ - override уровня приложения (формат значения FOO=BAR, может быть передано 0 или более раз)
* _--staging-override_ - override уровня стейджинга (формат значения FOO=BAR, может быть передано 0 или более раз)
