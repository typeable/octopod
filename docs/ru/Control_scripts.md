...
Вы можете возвращать различные exit code для сигнализации ошибок:
- `1` – обычная ошибка.
- `2` – deployment частично не работоспособен.
- `3` – не соответствие тега, развернутый deployment имеет другой тег.
