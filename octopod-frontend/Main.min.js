...
var $author$project$Page$Sidebar$CreateUpdate$initUpdate = F4(
	function (navKey, config, visibility, deploymentName) {
		return {appDefaults: $krisajenkins$remotedata$RemoteData$Loading, appKeys: $krisajenkins$remotedata$RemoteData$Loading, appOverrides: $krisajenkins$remotedata$RemoteData$Loading, config: config, deployment: $krisajenkins$remotedata$RemoteData$Loading, deploymentDefaults: $krisajenkins$remotedata$RemoteData$Loading, deploymentKeys: $krisajenkins$remotedata$RemoteData$Loading, deploymentOverrides: $krisajenkins$remotedata$RemoteData$Loading, mode: $author$project$Page$Sidebar$CreateUpdate$Update, name: deploymentName, nameEdited: false, navKey: navKey, saveResp: $krisajenkins$remotedata$RemoteData$NotAsked, visibility: visibility};
	});
...
var $author$project$Api$Endpoint$url = F3(
	function (mAppUrl, paths, queryParams) {
		if (mAppUrl.$ === 'Just') {
			...
			return $author$project$Api$Endpoint$Endpoint(
				A2($elm$url$Url$Builder$absolute, paths, queryParams));
		}
	});
		...
		return _Utils_Tuple2(
			{
				...
				settings: settings,
				sidebar: A4($author$project$Page$Sidebar$CreateUpdate$initUpdate, settings.navKey, config, false, deploymentName)
			},
...
var $author$project$Page$Sidebar$CreateUpdate$initCreate = F3(
	function (navKey, config, visibility) {
		return {
			appDefaults: $krisajenkins$remotedata$RemoteData$Loading,
		...
		return _Utils_Tuple2(
			{
				...
				settings: settings,
				showArchived: false,
				sidebar: A3($author$project$Page$Sidebar$CreateUpdate$initCreate, settings.navKey, config, false),
				updated: 0
			},
...
var $author$project$Page$Deployment$DeleteDeploymentResp = F2(
	function (a, b) {
		return {$: 'DeleteDeploymentResp', a: a, b: b};
	});
	...
	function (config, deploymentName) {
		return A5(
			...
			A2(
				...
				$author$project$Page$Deployment$DeleteDeploymentResp(deploymentName)));
	});
...
var $author$project$Page$Deployment$RestoreDeploymentResp = F2(
	function (a, b) {
		return {$: 'RestoreDeploymentResp', a: a, b: b};
	});
	...
	function (config, deploymentName) {
		return A4(
			...
			A2(
				$elm$core$Basics$composeR,
				$krisajenkins$remotedata$RemoteData$fromResult,
				$author$project$Page$Deployment$RestoreDeploymentResp(deploymentName)));
	});
				...
				if (cmd.a.$ === 'Success') {
					return _Utils_Tuple2(
						...
						A2(
							...
							model.navKey,
							$author$project$Route$Deployment(model.name)));
				} else {
					var resp = cmd.a;
					return _Utils_Tuple2(
						_Utils_update(
			...
			case 'ShowSidebar':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							sidebar: A4($author$project$Page$Sidebar$CreateUpdate$initUpdate, model.settings.navKey, model.config, true, deployment.deployment.name)
						}),
					A2(
				...
				if (cmd.a.$ === 'ShowEditSidebar') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								sidebar: A4($author$project$Page$Sidebar$CreateUpdate$initUpdate, model.settings.navKey, model.config, true, deploymentName)
							}),
						A2(
							$elm$core$Platform$Cmd$map,
			...
			case 'ShowCreateSidebar':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							sidebar: A3($author$project$Page$Sidebar$CreateUpdate$initCreate, model.settings.navKey, model.config, true)
						}),
					A2(
						$elm$core$Platform$Cmd$map,
						$author$project$Page$Deployments$CreateSidebarMsg,
